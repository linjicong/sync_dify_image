...
| 源镜像                                          | 替换后镜像                                                     |
|-------------------------------------------------|----------------------------------------------------------------|
| langgenius/dify-api:0.15.2                       | registry.cn-hangzhou.aliyuncs.com/linjicong/dify-api:0.15.2     |
| langgenius/dify-web:0.15.2                     | registry.cn-hangzhou.aliyuncs.com/linjicong/dify-web:0.15.2    |
