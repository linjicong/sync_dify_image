...
| 源镜像                                          | 替换后镜像                                                     |
|-------------------------------------------------|----------------------------------------------------------------|
| langgenius/dify-api:0.14.0                       | registry.cn-hangzhou.aliyuncs.com/linjicong/dify-api:0.14.0     |
| langgenius/dify-web:0.14.0                     | registry.cn-hangzhou.aliyuncs.com/linjicong/dify-web:0.14.0    |
